...
public class VotingServiceImpl implements VotingServiceInterface {
     ...
     */
    public VotingServiceImpl(DataStoreReadInterface dbRead, DataStoreWriteInterface dbWrite) {
        this.dbRead = dbRead;
    ...
    public List<Question> getAllQuestions() {
        ...
        for (int i : ids) {
            Question question = new Question(i, dbRead.getTextOfQuestion(i),
                    dbRead.getStatusOfQuestion(i), dbRead.getVotesForQuestion(i));
    ...
    public void deleteQuestion(Question question) {
        if (question != null) {
            ...
            throw new IllegalStateException("Null is not a question that could be deleted.");
        }
    }
